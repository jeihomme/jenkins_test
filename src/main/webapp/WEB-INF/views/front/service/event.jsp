                ...
                <div class="notice_box">
                    <div class="mypeople_tab_box">
                        <ul class="mypeople_tab">
                            ...
                            <li><a href="javascript:;" class="mypeople_item" value="NOT01" onclick='fn_BtnChnageListCnt("", "NOT01", $(this) );'>공지</a></li>
                            <li><a href="javascript:;" class="mypeople_item active" value="NOT02" onclick='fn_BtnChnageListCnt("", "NOT02", $(this) );'>이벤트</a></li>
                    ...
                    <div id="dataList" class="board_box">
                    	<table class="board_detail_table"></table>
                    </div>

					<div class="pagination justify-content-center paging">
						<ul style="justify-content:space-between;  text-align: center; display:block !important;" id="dataPage"></ul>
					</div>
...
var chk = 0;
$(function(){
	$('.mypeople_item').eq(2).trigger('click');
	chk = 1;
	...
	$('#'+OBJECT_ID+'').empty();
	 ...
	 if( jsonData.length > 0 ) {
		...
		$.each(jsonData, function(key, val) {
			...
			inTag += '</p>';
			inTag += '</td>';
			inTag += '<td class="date" style="width: 30% !important;">';
		...
		inTag += '<div class="mlt_row hasbtn"style="color:#aaa;text-align:center; ">등록된 내용이 없습니다.</div>';
		$('#'+OBJECT_ID+'').append( inTag );
	 }
...
//  INFO |--------|--------|-------------|------------|---------|-----------------------------------------------|--------------------------------|-------------| 
	...
	$.each(jsonData, function(key, val) {
		...
		inTag += '<colgroup><col width="10%"><col width="65%"><col width="25%">';
		inTag += '</colgroup>';
		...
		inTag += '<div class="board_detail_content phone_board_detail_content">';
		inTag += '<p>'+val.NOTI_CNTN+'</p>';
		
		console.log( $('#imgTag').val() );
		
		if( val.NOTI_UUID != '' && val.NOTI_UUID != null && val.NOTI_UUID != undefined ) {
