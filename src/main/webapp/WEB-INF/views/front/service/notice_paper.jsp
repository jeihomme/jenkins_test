...
var chk = 0;
$(function(){
	$('.mypeople_item').eq(3).trigger('click');
	chk = 1;
...
// 			inTag += '<a href="#" onclick="fn_BtnDetail(\''+OBJECT_ID+'\', '+val.NOTI_IDX+');">';
		...
		inTag += '<div class="mlt_row hasbtn"style="font-size:22px; color:#aaa;text-align:center; padding: 140px 0;">등록된 내용이 없습니다.</div>';
		$('#'+OBJECT_ID+'').append( inTag );
	 }
