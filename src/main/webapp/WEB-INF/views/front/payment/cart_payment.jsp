        ...
        <section>
            <div class="section_inner">
                <div class="section_cont_top">
					...
					<div class="breadcrumb" style="    right: 25px;">
                    ...
                    <div class="cart_pymt_article coupon">
                        <div class="cart_pymt_article_row">
                            ...
                            <div class="cart_pymt_article_col">
                                ...
                                <select name="COUP_LIST" id="" class="select select_white" style="color: #999!important;">
                                </select>
                                <select name="PRDT_LIST" id="" class="select select_white" style="color: #999!important;">
                                </select>
                            </div>
                            <div class="cart_pymt_article_col">
				                                ...
				                                <ul class="designRadiobutton form-control-sm"  >
				                                	<li style="display: inline-block;">
					                                	<div class="designRadiobutton form-control-sm">
															...
															<label for="receiptApplyed_true"  class="label_txt">신청하기</label>
														</div>
													</li>
													<li style="display: inline-block;">
														<div class="designRadiobutton form-control-sm">
															<input type="radio" id="receiptApplyed_false" name="CASH_RECEIPT" value="false" checked="checked" >
															<label for="receiptApplyed_false" class="label_txt">신청안함</label>
														</div>
													</li>
										        </ul>
										        <br>
...
<div id="childRegisterPop4" class="popup_wrap">
	...
	<div class="popup_box">
	<div class="popup_content register_popup_content4 phone_popup_content teblet_popup_content" style="text-align:left;">
...
<div id="childRegisterPop3" class="popup_wrap">
                            <div class="popup_layer"></div>
                            <div class="popup_box">
                                <div class="popup_content phone_popup_content teblet_popup_content register_popup_content3 phone_register_popup_content3" style="text-align:left;">
<!--                                     <button type="button" class="pop_close"></button> -->
...
<!--                                     <button type="button" class="pop_close"></button> -->
                                    ...
                                    <div class="register_pop_box">
                                        <h4 class="rp_title">결제대행서비스 이용약관</h4>
                                        <p class="rp_text">
										<div class="over" style=" overflow-y:scroll; height:400px; padding-right: 10px;
...
<%-- console.log("sndMsalt"     +" : "+  "<%=msalt%>"	); --%>
<%-- console.log("sndMpayMsalt" +" : "+  "<%=mpaymsalt%>"); --%>
<%-- console.log("sndEdata"     +" : "+  "<%=edata%>"    ); --%>
<%-- console.log("sndEtoken"    +" : "+  "<%=etoken%>"   );      --%>
...
// 			params.TIME_IDX = val;
		...
		$('[name=payArr]').val( payArr );
		$('[name=payCouponVal]').val( $('[name=COUP_LIST]').val() );
		$('[name=payMethod]').val( $('[name=sndPaymethod]').val() );
		$('[name=payAmout]').val( $('[name=sndAmount]').val() );
...
// 	baskCnt = tempCnt.slice(  0 , tempCnt.length-1 );
$( function() {
...
// 		$.each(prdtUseDtm, function(key, val){
		    ...
		    html += '                <div class="product_arae_term timedealDiv" style="display:none;">';
// 		    html += '                <div class="timedealDiv" style="display:none;">';
		    ...
		    console.log(1*tempCnt[typeTemp]*v.PRDT_PRIC_REAL_NOCOMMA);
		    console.log(1*tempCnt[typeTemp]*v.DEAL_REAL_PRIC);
		    
		    console.log(tempCnt);
		    console.log(tempCnt[typeTemp]);
		    console.log(v.DEAL_REAL_PRIC);
		    console.log(v.PRDT_PRIC_REAL_NOCOMMA);
...
// 				    html   += '                        <span>'+getRidOfDupleDate( val )+'분</span>';
			...
			html += '    </td>';
		    html += '    <td>';
		    html += '        <span class="color_main">'+numberWithCommas( 1*tempCnt[typeTemp]*v.PRDT_PRIC_REAL_NOCOMMA )+' 원</span>';
...
// 			    mHtml   += '                        <span>'+getRidOfDupleDate( val )+'</span>';
			...
			if ( v.PRDT_TYPE == 'VOD' ) {
				mHtml += 	'						<input type="hidden" name="prdt_cnt" value="1" maxlength="3" onkeyup="changeCnt(this.value);" readonly=readonly />';
			}else{
				mHtml += 	'						<a class="opt-cnt-minus '+( tempCnt[typeTemp] > 1 ?'' : 'disabled') +' " href="javascript:void(0)" onclick="return false;">-</a>';
				mHtml += 	'						<input type="text" name="prdt_cnt" value="'+tempCnt[typeTemp]+'" maxlength="3" onkeyup="changeCnt(this.value);" readonly=readonly />';
...
// 	console.log( $('.cart_pymt_left .cart_pymt_final_table tbody > tr:eq(3) td').text() );
...
function counter( OPEN_DTM, BTN_DAY, BTN_TIME ){
	...
	if( OPEN_DTM != null ) {
		...
		console.log( timedealDivCnt );
		$('.timedealDiv').eq(timedealDivCnt).remove();
	}
	timedealDivCnt++;
}
</script>

<div class="popup popup_interest_free">
    <div class="popup_wrapper">
	    <div class="popup_container" style="    height: 600px;overflow-y:auto;"> 
...
<div class="popup popup_icon_help">
    <div class="popup_wrapper">
...
<div class="popup popup_isMobilePay">
    <div class="popup_wrapper">
	    <div class="popup_container">
	        <div class="popup_header">
...
<form name=KSPayWeb method=post  accept-charset="EUC-KR">
									...
									<select name=sndPaymethod style="display: none;">
										...
										<option value="11000" >마이페이</option>
									</select>

						<input type='hidden' name='sndStoreid' value='2001106623' size='15' maxlength='10'>
                        <input type='hidden' name='sndOrdernumber' value='' size='30'>

<!--           상품명 -->
		      <!--상품명 50Byte(한글 25자) 입니다. ' " ` 는 사용하실수 없습니다. 따옴표,쌍따옴표,백쿼테이션 -->
          <input type="hidden" name='sndGoodname' value='' size='25'>
          
<!--           금액 -->
		  <!--금액은 ,없이 입력 -->
          <input type='hidden' name='sndAmount' value='' size='15' maxlength='9'>
          
<!--           주문자명 -->
          <input type='hidden' name='sndOrdername' value='' size='30'>
          
<!--           전자우편 -->
		      <!--KSPAY에서 결제정보를 메일로 보내줍니다.(신용카드거래에만 해당)-->
          <input type='hidden' name='sndEmail' value='' size='30'>
...
<!--이 파라메터들은 지정된결과 페이지(kspay_result.jsp)로 전송됩니다.-->
	<input type="hidden" name="RECE_WHY"        value="">
	<input type="hidden" name="RECE_KIND"        value="">
	<input type="hidden" name="RECE_SID"        value="">
	<input type="hidden" name="payCouponVal"        value="">
	<input type="hidden" name="payMethod"        value="">
	<input type="hidden" name="payAmout"        value="">
<!--------------------------------------------------------------------------------------------------------------------------->
