...
<!--                                 </div> -->
        ...
        <div class="prdt_tab_area">
            <div class="section_inner">
                <div class="prdt_layout " style="overflow-x: auto;">
                    <div class="prdt_contents">
        ...
        <section class="section_prdt" data-idx="0">
            <div class="section_inner">
                <div class="prdt_layout">
                    <div class="prdt_contents">
                        <h3 class="prdt_section_title">상세정보</h3>
                        <div class="prdt_detail" style="white-space: pre-line;">
                        </div>
                    </div>
                </div>
            </div>
...
prdtCd = window.opener.prdtIdx;
cateIdx = window.opener.cateIdx;
// 	console.log( prdtCd );
...
// INFO |---------|---------------|--------|--------|--------|----------------|----------------|---------------|----------|---------|----------|-------------|--------|----------|---------------|----------|--------|--------------|-------------|--------------|--------------|--------------|--------| 
// INFO |PRDT_CD  |INFO_PRDT_UUID |CODE_NM |CODE_NM |USER_NM |INFO_PRDT_TITL1 |INFO_PRDT_TITL2 |INFO_PRDT_SUBT |PRDT_TYPE |PRDT_CNT |PRDT_PRIC |PRDT_DISC_CD |CODE_NM |PRDT_DISC |PRDT_PRIC_REAL |PRDT_CD   |FOLL_YN |PRDT_CD_VOD   |PRDT_CD_LIVE |PRDT_CD_CHAT  |PRDT_CD_FACE  |PRDT_CD_MAIL  |BASK_YN | 
// INFO |---------|---------------|--------|--------|--------|----------------|----------------|---------------|----------|---------|----------|-------------|--------|----------|---------------|----------|--------|--------------|-------------|--------------|--------------|--------------|--------| 
// INFO |[unread] |               |건강      |명상      |마스터1    |제목1 해줘          |제목2해줘           |부제 해줘          |1:1 코칭    |[null]   |[null]    |[null]       |[null]  |[null]    |[null]         |COACHING4 |0       |202011VLA0001 |[null]       |202011CNA0002 |202011FNA0013 |202011ENA0004 |0       | 
// INFO |---------|---------------|--------|--------|--------|----------------|----------------|---------------|----------|---------|----------|-------------|--------|----------|---------------|----------|--------|--------------|-------------|--------------|--------------|--------------|--------| 
			...
			if ( val.PRDT_CD.indexOf('COACHING') > -1 ) {
		        	...
		        	$.each( prdtList, function( k, v ){
		        		if( v.TIME_CNT > 0 || v.PRDT_CD2.indexOf('EN') > -1 ) {
				        	...
				        	console.log( PRDT_PRIC_REAL_temp );
				        	console.log( v.PRDT_PRIC_REAL );
...
// 				        	console.log( v );
				        	select_prdtList_Html += '	             <li id="prdt'+v.PRDT_CD2+'" class="m_prdt_list_item" data-val="'+psaeCnt+'" data-jjim="'+v.BASK_IDX2+'">';
					...
					inTag += '<div class="prdt_info_title"><span class="tag">1:1코칭</span> <span class="name">'+val.P_CODE_NM+' · '+val.USER_NM+'</span></div>';
...
// 					else inTag2 += '	     <button type="button" class="prdt_apply_btn masterHomeDetail" onclick="isMypageSetTime=1;">신청하기</button>';
				...
				inTag += '<div class="prdt_info_title"><span class="tag">'+val.PRDT_TYPE+'</span> <span class="name">'+val.P_CODE_NM+' · '+val.USER_NM+'</span></div>';
				inTag += '<p class="prdt_title">'+val.INFO_PRDT_TITL1+'</p>';
				inTag += '<p class="prdt_title">'+val.INFO_PRDT_TITL2+'</p>';
				if ( val.PRDT_TYPE != 'LIVE CLASS'  ) {
					inTag += '<p class="prdt_date"><i class="icon-play"></i>수강기간 '+val.PRDT_CNT+'일</p>';
				}
				inTag += '<div class="prdt_price">';
				inTag += '	<span class="prdt_price_won">'+val.PRDT_PRIC+' 원</span>';
				inTag += '	<div class="prdt_price_inn">';
				inTag += '		<span class="sale">'+val.PRDT_DISC+''+val.PRDT_DISC_NM+'</span>';
...
//     INFO |---------|--------------|-------------|--------------|--------------|--------------| 
//     INFO |CATE_IDX |PRDT_CD_VOD   |PRDT_CD_LIVE |PRDT_CD_CHAT  |PRDT_CD_FACE  |PRDT_CD_MAIL  | 
//     INFO |---------|--------------|-------------|--------------|--------------|--------------| 
//     INFO |4        |202011VLA0001 |[null]       |202011CNA0002 |202011FNA0013 |202011ENA0004 | 
//     INFO |---------|--------------|-------------|--------------|--------------|--------------| 
   	...
   	if( jsonDetail.length > 0 ) {
   		...
   		$.each(jsonDetail,function(key,val){
			...
			if( val.PRDT_CD.indexOf('VL') > -1 ) inTag += '			<span>VOD 함께 신청하기</span>';
			else if( val.PRDT_CD.indexOf('LN') > -1 ) inTag += '			<span>LIVE CLASS 함께 신청하기</span>';
			else inTag += '			<span>1.1코칭권 함께 신청하기</span>';
...
//     INFO |--------|------------|----------|------------|----------| 
//     INFO |USER_NM |SYS_REG_DTM |REVI_SCOR |REVI_CNTN   |REVI_UUID | 
//     INFO |--------|------------|----------|------------|----------| 
//     INFO |김블루     |2020-12-13  |4         |VOD의 최강자 !  |[null]    | 
//     INFO |--------|------------|----------|------------|----------| 
...
// INFO |--------|--------|---------|--------------|----------|----------------|----------------|---------------|----------|---------------------------------------------|------------------|---------| 
// INFO |CODE_NM |USER_NM |CATE_IDX |PRDT_CD       |PRDT_TYPE |INFO_PRDT_TITL1 |INFO_PRDT_TITL2 |PRDT_PRIC_REAL |PRDT_PRIC |INFO_TUMB_UUID                               |INFO_TUMB_UUID_NM |BASK_IDX | 
// INFO |--------|--------|---------|--------------|----------|----------------|----------------|---------------|----------|---------------------------------------------|------------------|---------| 
// INFO |건강      |마스터1    |4        |202011VLA0001 |VOD       |명상하기 좋은날        |이런 날에 명상하기      |48,000         |149,000   |202112018820e56352fcf2b74c387ce35e1751883098 |INFO_TUMB_UUID    |0        | 
// INFO |건강      |마스터1    |4        |202011VLA0001 |VOD       |명상하기 좋은날        |이런 날에 명상하기      |343,000        |763,431   |202112018820e56352fcf2b74c387ce35e1751883098 |INFO_TUMB_UUID    |0        | 
// INFO |건강      |마스터1    |4        |202011VLA0001 |VOD       |명상하기 좋은날        |이런 날에 명상하기      |475,000        |500,000   |202112018820e56352fcf2b74c387ce35e1751883098 |INFO_TUMB_UUID    |74       | 
// INFO |건강      |마스터1    |4        |202011VLA0001 |VOD       |명상하기 좋은날        |이런 날에 명상하기      |80,000         |80,000    |202112018820e56352fcf2b74c387ce35e1751883098 |INFO_TUMB_UUID    |0        | 
// INFO |--------|--------|---------|--------------|----------|----------------|----------------|---------------|----------|---------------------------------------------|------------------|---------| 
...
//   		    	$('#'+val.PRDT_CD+'').attr('src', $('#imgTag').val());
			    ...
			    inTag += '                    <span class="sale" style="color:red;font-size: 13px;">'+(100-((val.PRDT_PRIC_REAL.replace(',','')*1)/(val.PRDT_PRIC.replace(',','')*1))*100).toFixed(2)+'%</span>';
