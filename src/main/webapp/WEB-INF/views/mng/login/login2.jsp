...
<body >
   ...
   <table padding=0 margin=0>
		<tr><td colspan=2 style='text-align:center;background:#999999;padding-top:10px;color:white'><h3>Fiveplayer DEMO</td></tr>
		<tr><td colspan=2 height=20></td></tr>
		<tr >
			<td style='text-align:right'>
						User ID </font> &nbsp;&nbsp;<input type=text id='userid' name='userid' value='<%=userId%>' size=25> 
			</td>
			<td >
				
				<button class='my_button' onclick='changeid()' style='background:#555555;width:90%'>ID변경</button> 
				<script>function changeid()	{ document.location.href='/mng/yoyo/sample?userId='+document.getElementById('userid').value;}</script>
			</td>
		</tr>
		<tr height=20></tr>
		<tr>
			...
			<td width=40% align=center> 
				<button onclick='open_fiveplayer("<%=makeFiveplayerToken(request, userId, "video/peoplemade/demo-01.mp4","1") %>",document.location.href)' title='streaming'>play</button>
				<button onclick='open_fiveplayer_downloader("<%=makeFiveplayerToken(request, userId, "video/peoplemade/demo-01.mp4","1") %>",document.location.href)' title='streaming'>save</button>
			</td>
		</tr>		
		<tr>
			<td width=60%>[파일경로]</td>
		...
		<tr>
			...
			<td style='text-align:left;border:none' >  <br>
				<button class=my_button onclick='open_fiveplayer_installer()' style='background:#555555;width:90%'>
