			...
			<tr>
				...
				<td>
					<div class="form-inline">
						<input type="text" name="LECT_CD" class="form-control form-control-sm col-8" readonly="readonly" disabled="disabled"/>
					</div>				
				</td>
			</tr>
			<tr>
...
<!-- 			<tr> -->
<!-- 				<th scope="row">동영상 이미지<span class="red">*</span></th> -->
<!-- 				<td colspan="3"> -->
<!-- 					<div class="fileArea">				 -->
<!-- 						<input type="file" id="LECT_UUID_FILE" name="LECT_UUID_FILE" style="display:none;margin-left:0px;" multiple maxsize="100" maxcount="100" totalsize="1000" callback="fn_fileUpload"  -->
...
<!-- 						/>	 -->
<!-- 						<label class="btn btn-sm btn-outline-secondary" for="LECT_UUID_FILE" >파일선택</label> -->
<!-- 											<span class="file_possible" style="color:red !important;">( 이미지 파일만 )</span>							 -->
<!-- 						<div class="fileList" id="LECT_UUID_FILEList"></div> -->
<!-- 						<input id="LECT_UUID" name="LECT_UUID" type="hidden" /> -->
<!-- 						<div id="LECT_UUID_FILEListClone" style="display:none;"> -->
			...
			<tr>
				...
				<td colspan="3">
					<div class=" form-control-sm">
						...
						<input type="text" id="LECT_PLAY_LINK" name="LECT_PLAY_LINK" style="display: inline-block;" placeholder="ex) http://peoplemade.com" class=" form-control form-control-sm col-9">
					</div>
				</td>
			</tr>
			<tr>
...
<!-- 									<th scope="col">상품1</th> -->
<!-- 									<td> -->
<!-- 										<input name="LECT_RELA_PRDT1" type="text"  placeholder="내용을 입력하세요" class="form-control form-control-sm col-8"> -->
<!-- 									</td> -->
<!-- 									<th scope="col">상품2</th> -->
<!-- 									<td> -->
<!-- 										<input name="LECT_RELA_PRDT2" type="text"  placeholder="내용을 입력하세요" class="form-control form-control-sm col-8"> -->
<!-- 									</td> -->
<!-- 								</tr> -->
<!-- 								<tr> -->
<!-- 									<th scope="col">상품3</th> -->
<!-- 									<td> -->
<!-- 										<input name="LECT_RELA_PRDT3" type="text"  placeholder="내용을 입력하세요" class="form-control form-control-sm col-8"> -->
<!-- 									</td> -->
<!-- 									<th scope="col">상품4</th> -->
<!-- 									<td> -->
<!-- 										<input name="LECT_RELA_PRDT4" type="text"  placeholder="내용을 입력하세요" class="form-control form-control-sm col-8"> -->
<!-- 									</td> -->
<!-- 								</tr> -->
<!-- 								<tr> -->
<!-- 									<th scope="col">상품5</th> -->
<!-- 									<td> -->
<!-- 										<input name="LECT_RELA_PRDT5" type="text"  placeholder="내용을 입력하세요" class="form-control form-control-sm col-8"> -->
<!-- 									</td> -->
<!-- 									<th scope="col">상품6</th> -->
<!-- 									<td> -->
<!-- 										<input name="LECT_RELA_PRDT6" type="text"  placeholder="내용을 입력하세요" class="form-control form-control-sm col-8"> -->
<!-- 									</td> -->
<!-- 								</tr> -->
<!-- 							</tbody> -->
<!-- 						</table> -->
...
<!-- 										<td></td> -->
					...
					<div class="btn_wrap" style="text-align: right;">
						<button type="button" onclick="fn_addVod();" class="btn btn-md btn_key_color" style="width: 140px;">선택상품 추가</button>					
					</div>
									...
									<tr>
										...
										<td >
											...
											<div class="form-inline">
												...
												<input type="text" name="MATE_DISC" value="0" class="form-control form-control-sm col-8" placeholder=""style="margin-top: 4px; margin-left: 70px" onchange="fn_CalcPriceMATE();" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
											</div>
											<div class="form-inline">
												<span style="padding: 8px;display: inline-block;">판매금액 : </span> 
...
$(function(){
	...
	var params = new Object();
	params.LECT_IDX = '${out.params.lectIdx }';
	params.query = 'selectMngLectDetailList';
	params.status = "LIST";
	var listJson = fn_DataAjax2( params );
	if ( listJson.out.detail.data.length > 0 ) {
		firstClick = false;
		var html = "";
		$('#addVod_Target').empty();
		$.each(listJson.out.detail.data, function(k,v){
			html += '<tr id="'+v.VOD_CD+'">';
			html += '		<td>'+v.VOD_CD+'</td>';
			html += '		<td>'+v.VOD_NM+'</td>';
// 			html += '		<td>'+v.VOD_STAT_CD+'</td>';
			html += '		<td>'+v.VOD_PROG+'</td>';
			html += '		<td>'+v.SYS_REG_DTM+'</td>';
// 			html += '		<td><input type="text" name="ORDE" class="form-control form-control-sm col-8" value="'+v.DATA_ORDE+'"/><input type="hidden" name="DATA_IDX" value="'+v.DATA_IDX+'" /><input type="hidden" name="VOD_IDX" value="'+v.VOD_IDX+'" /></td>';
	...
	var params = new Object();
	params.LECT_IDX = '${out.params.lectIdx }';
	params.query = 'selectMngLectMatelList';
	params.status = "LIST";
	params.mngLoginIdx = localStorage.getItem("mngLoginIdx");
	var mateJson = fn_DataAjax2( params );
	if ( mateJson.out.detail.data.length > 0 ) {
		var html = "";
		$('#addMate_Target').empty();
		
		$.each(mateJson.out.detail.data, function(k,v){
			html += '<tr id="mate'+v.MATE_IDX+'">';
			html += '		<td>'+v.MATE_NM+'</td>';
			html += '		<td>'+v.MATE_CD+'</td>';
			html += '		<td>'+v.MATE_PRIC_REAL+'</td>';
...
// 	if ( $('[name=LECT_UUID]').val().trim() == '' || $('[name=LECT_UUID]').val().trim() == null ) return alert('내 강의실 이미지를 선택해 주세요.');
...
// 	if (ordeChk) return alert('강의 순서를 전부 입력해 주세요.');
	...
	params.status = "EDIT";
	params.query = "updateMngLectData";
	params.mngLoginIdx = localStorage.getItem("mngLoginIdx");
	params.LECT_IDX = '${out.params.lectIdx }';
...
// 				html += '		<td><input type="text" name="ORDE" class="form-control form-control-sm col-8" /><input type="hidden" name="DATA_IDX" value="" /></td>';
				html += '		<td><a class="removeVod">삭제</a></td>';
				html += '</tr>';
			}
...
function fn_BtnDelete(){
	if (confirm('강좌를 삭제하시겠습니까?')) {
		...
		var params = new Object();
		params.status = "DELETE";
		params.query = "deleteMngLectData";
		params.mngLoginIdx = localStorage.getItem("mngLoginIdx");
		params.LECT_IDX = '${out.params.lectIdx }';
		fn_DataAjax( params );
		location.href='${unit.move("index", "" )}';
...
$(document).on('change','#LECT_PLAY',function(){
	$('[name=LECT_PLAY_LINK]').val('');
});

// $(document).on('change','[name=LECT_PLAY_LINK]',function(){
// 	if( $('#LECT_PLAY').val() != 'PLAY03') {
