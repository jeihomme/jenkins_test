...
// INFO |---------|----------|-----------|-----------|-----------|-----------|---------|-----------------------------------------------|-----------------------------------------------|----------|----------|------------|-------------|-------------| 
// INFO |BANN_IDX |BANN_TYPE |BANN_TITL1 |BANN_TITL2 |BANN_SUBT1 |BANN_SUBT2 |BANN_CLR |BANN_UUID_WEB                                  |BANN_UUID_MOBI                                 |BANN_LINK |BANN_ORDR |BANN_USE_YN |BANN_STR_DTM |BANN_END_DTM | 
// INFO |---------|----------|-----------|-----------|-----------|-----------|---------|-----------------------------------------------|-----------------------------------------------|----------|----------|------------|-------------|-------------| 
// INFO |9        |BNN01     |           |           |           |           |#000000  |20210111105026032044425a524f71a345ee83cb4b9cca |20210111105026032044425a524f71a345ee83cb4b9cca |링링        |1         |Y           |2021-01-11   |2021-01-18   | 
// INFO |---------|----------|-----------|-----------|-----------|-----------|---------|-----------------------------------------------|-----------------------------------------------|----------|----------|------------|-------------|-------------| 
	  
	 
	var params = new Object();
	params.status = "DETAIL";
	params.query = "selectMngBannDetail";
	...
	} else if( $('[name=BANN_TYPE]').val() == 'BNN02' ) {		
	$('.file_possible1').show();
	$('.file_possible2').hide();
	$('.file_possible3').hide();
	...
	} else if( $('[name=BANN_TYPE]').val() == 'BNN03' ) {	
...
$('[name=BANN_TYPE]').change(function(){
...
var setColorPicker = function( colorId ){
	...
	$('#'+colorId).find('div').css('backgroundColor', $('[name=BANN_CLR]').val()+' !important');
...
function fn_BtnRegist(){
	...
	params.status = "EDIT";
	params.query = "updateMngBannData";
...
function fn_BtnDelete(){
	...
	if( confirm('해당 게시글을 삭제하시겠습니까?') ) {
		...
		params.query = "deleteMngBannData";
		params.mngLoginIdx = localStorage.getItem("mngLoginIdx");
