			...
			<tr>
				...
				<td>
					<div class="form-inline">
						<input type="hidden" name="CHAT_IDX" class="form-control form-control-sm col-8"/>
						<input type="text" name="CHAT_CD" class="form-control form-control-sm col-8" DISABLED />
					</div>			
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="form-inline">
						<div class="designRadiobutton form-control-sm">
							<input type="radio" id="radio1_2" name="CHAT_STAT_CD" value="SAL01" checked/>
							<label for="radio1_2" class="label_txt">판매대기</label>
						</div>
						<div class="designRadiobutton form-control-sm">
							<input type="radio" id="radio1_1" name="CHAT_STAT_CD" value="SAL02" />
							<label for="radio1_1" class="label_txt">판매중</label>
						</div>
						<div class="designRadiobutton form-control-sm">
							<input type="radio" id="radio1_3" name="CHAT_STAT_CD" value="SAL03" />
...
<!-- 				<td> -->
<!-- 					<select id="CHAT_STAT_CD" name="CHAT_STAT_CD" class="form-control form-control-sm col-8"> -->
<!-- 					</select> -->
<!-- 				</td> -->
<!-- 			</tr> -->
<!-- 			<tr> -->
...
<!-- 				<td> -->
<!-- 					<div class="form-inline"> -->
<!-- 						<input type="text" name="CHAT_NM" class="form-control form-control-sm col-8" /> -->
<!-- 					</div>				 -->
<!-- 				</td> -->
<!-- 			</tr> -->
			<tr>
...
<!-- 			<tr> -->
<!-- 				<th>상담정보 이미지<span style="color:red">*</span></th> -->
<!-- 				<td colspan="3"> -->
<!-- 					<div class="fileArea">				 -->
<!-- 						<input type="file" id="CHAT_IMG_UUID_FILE" name="CHAT_IMG_UUID_FILE" style="display:none;margin-left:0px;" maxsize="100" maxcount="100" totalsize="1000" callback="fn_fileUpload"  -->
...
<!-- 						/>	 -->
<!-- 						<label class="btn btn-sm btn-outline-secondary" for="CHAT_IMG_UUID_FILE" >파일선택</label> -->
<!-- 											<span class="file_possible" style="color:red !important;">( 이미지 파일만 )</span>							 -->
<!-- 						<div class="fileList" id="CHAT_IMG_UUID_FILEList"></div> -->
<!-- 						<input id="CHAT_IMG_UUID" name="CHAT_IMG_UUID" type="hidden" /> -->
<!-- 						<div id="CHAT_IMG_UUID_FILEListClone" style="display:none;"> -->
...
<!-- 			</tr>	 -->
			...
			<tr>
				...
				<td colspan="3" >
					<select id="CHAT_REST" name="CHAT_REST" class="form-control form-control-sm col-1">
						<option value="">선택해주세요</option>
			...
			<tr rowspan="3" >
				...
				<td colspan="3" >
					<div class="form-inline">
						...
						<input type="text" name="CHAT_PRIC" class="form-control form-control-sm col-8" placeholder="ex)50000" onchange="fn_CalcPrice();" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
					</div>
					<div class="form-inline">
						<span style="padding: 8px;display: inline-block;">할인종류 : </span> 
						<select id="CHAT_DISC_CD" name="CHAT_DISC_CD" class="form-control form-control-sm col-2" onchange="fn_CalcPrice();" >
							<option value="">전체</option>
						</select>
					<input type="text" name="CHAT_DISC" value="0" class="form-control form-control-sm col-6-2" placeholder="" onchange="fn_CalcPrice();" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" style="    margin-left:4px; ">			</div>
					<div class="form-inline">
						<span style="padding: 8px;display: inline-block;">판매금액 : </span> 
						<input type="text" name="CHAT_PRIC_REAL" class="form-control form-control-sm col-8" placeholder="" READONLY /> 
						<span style="padding: 8px;display: inline-block;">( * 10원 단위 절삭 )</span>
					</div>
				</td>
			</tr>		
<!-- 			<tr> -->
<!-- 				<th scope="row">메일알람설정<span style="color:red">*</span></th> -->
<!-- 				<td colspan="3" style="text-align:center;"> -->
<!-- 					<div class="form-inline"> -->
<!-- 						<input type="checkbox" id="CHAT_MAIL_YN" name="CHAT_MAIL_YN" class="input_on-off"> -->
<!-- 						 <label for="CHAT_MAIL_YN" class="label_on-off">  -->
...
<!-- 			</tr>		 -->
<!-- 			<tr> -->
<!-- 				<th scope="row">문자알람설정<span style="color:red">*</span></th> -->
<!-- 				<td colspan="3" style="text-align:center;"> -->
<!-- 					<div class="form-inline"> -->
<!-- 						<input type="checkbox" id="CHAT_SMS_YN" name="CHAT_SMS_YN" class="input_on-off"> -->
<!-- 						 <label for="CHAT_SMS_YN" class="label_on-off">  -->
<!-- 						   <span class="marble"></span> -->
<!-- 						   <span class="on">공개</span> -->
<!-- 						   <span class="off">비공개</span> -->
<!-- 						 </label> -->
...
<!-- 			</tr> -->
<!-- 			<tr> -->
<!-- 				<th scope="row">(옵션)<br>비밀번호설정</th> -->
<!-- 				<td colspan="3" > -->
<!-- 					<div class="form-inline"> -->
<!-- 						<span>비밀번호를 입력한 회원만 입장 가능하도록 허용합니다. </span> -->
<!-- 						<input type="checkbox" id="CHAT_PW_YN" name="CHAT_PW_YN" class="input_on-off"> -->
<!-- 						 <label for="CHAT_PW_YN" class="label_on-off">  -->
<!-- 						   <span class="marble"></span> -->
<!-- 						   <span class="on">공개</span> -->
<!-- 						   <span class="off">비공개</span> -->
<!-- 						 </label> -->
<!-- 					</div>		 -->
<!-- 					<div class="form-inline"> -->
<!-- 						<input type="password" name="CHAT_PW" class="form-control form-control-sm col-8" style="display: none;"/> -->
<!-- 					</div>				 -->
<!-- 				</td> -->
<!-- 			</tr> -->
		</tbody>
...
// 	fn_makeSummerNote('NOTI_CNTN');
	...
	fn_SelectOption("","SAL","CHAT_STAT_CD");
// 	fn_SelectOption("","CAT","CATE_PARENT_CD");
// 	fn_SelectOption("CAT01","","CATE_CD");
	fn_SelectOption("","DIS","CHAT_DISC_CD"); 
	
	var params = new Object();
	params.status = "DETAIL";
	params.query = "selectMngChatDetail";
	params.chatIdx = '${out.params.chatIdx }';
	fn_DataDetail( params );

	var jsonData = fn_DataAjax2(params);
	$('[name=CHAT_STAT_CD]').eq(0).val('SAL01');
	$('[name=CHAT_STAT_CD]').eq(1).val('SAL02');
	$('[name=CHAT_STAT_CD]').eq(2).val('SAL03');
	$('[name=CHAT_STAT_CD]:radio[value="'+jsonData.out.detail.data[0].CHAT_STAT_CD+'"]').prop('checked',true);
...
// 	$('[name=CHAT_PW]').val( atob( $('[name=CHAT_PW]').val() ) );
// 	if( $('[name=CHAT_PW]').val() != '' ) $("#CHAT_PW_YN").click();
...
$("#CHAT_PW_YN").click(function(){
	if( $('input:checkbox[name=CHAT_PW_YN]').is(':checked') ) {
		$('[name=CHAT_PW]').show();
	} else {
		$('[name=CHAT_PW]').val('');
		$('[name=CHAT_PW]').hide();
...
function fn_CalcPrice() {
	var price = "";
	var CHAT_DISC = $('[name=CHAT_DISC]').val()*1;
	
// 	if( $('#CHAT_DISC_CD').val() == '' ) alert('할인 종류를 선택해주세요.');

	if( $('#CHAT_DISC_CD').val() == 'DIS01') {
		//% 단위 계산
		if( CHAT_DISC > 100 ) CHAT_DISC = 100;
		price = $('[name=CHAT_PRIC]').val() - ($('[name=CHAT_PRIC]').val() * CHAT_DISC*0.01);
	} else if( $('#CHAT_DISC_CD').val() == 'DIS02') {
		//원 단위 계산
		if ($('[name=CHAT_PRIC]').val()*1 < CHAT_DISC ) CHAT_DISC = $('[name=CHAT_PRIC]').val();
		price = $('[name=CHAT_PRIC]').val() - CHAT_DISC;
	}
	
	$('[name=CHAT_PRIC_REAL]').val( Math.floor(price/10) * 10 );
	$('[name=CHAT_DISC]').val( Number($('[name=CHAT_DISC]').val()) );
}
...
// 	fn_SelectOption("","TIM","TIME_CD");
	...
	params.chatIdx = $('[name=CHAT_IDX]').val();
// 	params.chatIdx = '0';
...
function fn_BtnRegist(){
	...
	params.status = "EDIT";
	params.query = "updateMngChatData";
	params.mngLoginIdx = localStorage.getItem("mngLoginIdx");
	params.CHAT_PW = btoa( params.CHAT_PW );
	params.CHAT_STAT_CD = $('input[name="CHAT_STAT_CD"]:checked').val();
	
	// 노출여부 공개
// 	if( $('input:checkbox[name=CHAT_MAIL_YN]').is(':checked') ) params.CHAT_MAIL_YN = 'Y';
// 	else params.CHAT_MAIL_YN = 'N';
// 	if( $('input:checkbox[name=CHAT_SMS_YN]').is(':checked') ) params.CHAT_SMS_YN = 'Y';
// 	else params.CHAT_SMS_YN = 'N';
...
function fn_BtnDelete(){
	...
	if( confirm('해당 게시글을 삭제하시겠습니까?') ) {
		...
		var params = unit_getParams("searchArea");
		params.status = "DELETE";
		params.query = "deleteMngChatData";
		params.mngLoginIdx = localStorage.getItem("mngLoginIdx");
