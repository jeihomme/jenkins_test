			...
			<tr>
				...
				<td colspan="3" style="text-align:left;">
					<div class="designRadiobutton form-control-sm">
						<input type="radio" id="radio0_Y" name="CHAT_STAT_CD" value="SAL01" checked/>
						<label for="radio0_Y" class="label_txt">판매대기</label>
					</div>
					<div class="designRadiobutton form-control-sm">
						<input type="radio" id="radio0_N" name="CHAT_STAT_CD" value="SAL02" />
						<label for="radio0_N" class="label_txt">판매중</label>
					</div>
					<div class="designRadiobutton form-control-sm">
						<input type="radio" id="radio1_N" name="CHAT_STAT_CD" value="SAL03" />
...
<div id="writeTime" class="alert_wrap">
	...
	<tbody>
									...
									<tr>
										...
										<td style="text-align:left;">
											<div id="TIME_DTM_DIV" style="display: inline-block;">
									...
									<tr>
										...
										<td style="text-align:left;">
											<div id="TIME_STR_DIV" style="width: 260px;display: inline-block;"></div>
...
function fn_BtnRegist(){
	...
	// 	if ( $('[name=NOTI_CNTN]').val().trim() == '' || $('[name=NOTI_CNTN]').val().trim() == null ) return alert('내용을 입력해 주세요.');
		...
		params.status = "WRITE";
		params.query = "insertMngChatData";
		params.mngLoginIdx = localStorage.getItem("mngLoginIdx");
		params.CHAT_CD = '${sysDateValue}'+'CN';
