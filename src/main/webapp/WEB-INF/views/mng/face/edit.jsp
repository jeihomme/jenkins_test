			...
			<tr>
				...
				<td>
					<div class="form-inline">
						<input type="hidden" name="FACE_IDX" class="form-control form-control-sm col-8"/>
						<input type="text" name="FACE_CD" class="form-control form-control-sm col-8" DISABLED />
					</div>			
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="form-inline">
						<div class="designRadiobutton form-control-sm">
							<input type="radio" id="radio1_2" name="FACE_STAT_CD" value="SAL01" checked/>
							<label for="radio1_2" class="label_txt">판매대기</label>
						</div>
						<div class="designRadiobutton form-control-sm">
							<input type="radio" id="radio1_1" name="FACE_STAT_CD" value="SAL02" />
							<label for="radio1_1" class="label_txt">판매중</label>
						</div>
						<div class="designRadiobutton form-control-sm">
							<input type="radio" id="radio1_3" name="FACE_STAT_CD" value="SAL03" />
...
<!-- 				<td> -->
<!-- 					<div class="form-inline"> -->
<!-- 						<input type="text" name="FACE_NM" class="form-control form-control-sm col-8" /> -->
<!-- 					</div>				 -->
<!-- 				</td> -->
<!-- 			</tr> -->
			<tr>
...
<!-- 				<td colspan="3"> -->
<!-- 					<div class="fileArea">				 -->
<!-- 						<input type="file" id="FACE_IMG_UUID_FILE" name="FACE_IMG_UUID_FILE" style="display:none;margin-left:0px;" maxsize="100" maxcount="100" totalsize="1000" callback="fn_fileUpload"  -->
...
<!-- 						/>	 -->
<!-- 						<label class="btn btn-sm btn-outline-secondary" for="FACE_IMG_UUID_FILE" >파일선택</label> -->
<!-- 											<span class="file_possible" style="color:red !important;">( 이미지 파일만 )</span>							 -->
<!-- 						<div class="fileList" id="FACE_IMG_UUID_FILEList"></div> -->
<!-- 						<input id="FACE_IMG_UUID" name="FACE_IMG_UUID" type="hidden" /> -->
<!-- 						<div id="FACE_IMG_UUID_FILEListClone" style="display:none;"> -->
...
<!-- 					<div class="form-inline"> -->
<!-- 						<input type="checkbox" id="FACE_MAIL_YN" name="FACE_MAIL_YN" class="input_on-off"> -->
<!-- 						 <label for="FACE_MAIL_YN" class="label_on-off">  -->
<!-- 						   <span class="marble"></span> -->
<!-- 						   <span class="on">활성</span> -->
<!-- 						   <span class="off">비활성</span> -->
<!-- 						 </label> -->
<!-- 					</div>		 -->
<!-- 				</td> -->
<!-- 			</tr>		 -->
...
<!-- 				<td colspan="3" style="text-align:center;"> -->
<!-- 					<div class="form-inline"> -->
<!-- 						<input type="checkbox" id="FACE_SMS_YN" name="FACE_SMS_YN" class="input_on-off"> -->
<!-- 						 <label for="FACE_SMS_YN" class="label_on-off">  -->
<!-- 						   <span class="marble"></span> -->
<!-- 						   <span class="on">활성</span> -->
<!-- 						   <span class="off">비활성</span> -->
<!-- 						 </label> -->
...
<!-- 				<td colspan="3" > -->
<!-- 					<div class="form-inline"> -->
<!-- 						<span>비밀번호를 입력한 회원만 입장 가능하도록 허용합니다. &nbsp&nbsp</span> -->
<!-- 						<input type="checkbox" id="FACE_PW_YN" name="FACE_PW_YN" class="input_on-off"> -->
<!-- 						 <label for="FACE_PW_YN" class="label_on-off">  -->
<!-- 						   <span class="marble"></span> -->
<!-- 						   <span class="on">활성</span> -->
<!-- 						   <span class="off">비활성</span> -->
<!-- 						 </label> -->
<!-- 					</div>		 -->
<!-- 					<div class="form-inline"> -->
<!-- 						<input type="password" name="FACE_PW" class="form-control form-control-sm col-8" style="display: none;"/> -->
<!-- 					</div>				 -->
<!-- 				</td> -->
<!-- 			</tr> -->
		</tbody>
...
// 	$('[name=FACE_PW]').val( atob( $('[name=FACE_PW]').val() ) );
// 	if( $('[name=FACE_PW]').val() != '' ) $("#FACE_PW_YN").click();
...
// 	} else 
// 	if( $('#writeTimeTbody').html().indexOf( $('.addTimeHour').val()+':'+$('.addTimeMin').val() ) > -1 ) {
// 	} else {
...
function fn_BtnRegist(){
	...
	params.status = "EDIT";
	params.query = "updateMngFaceData";
	params.mngLoginIdx = localStorage.getItem("mngLoginIdx");
...
function fn_BtnDelete(){
	...
	if( confirm('해당 게시글을 삭제하시겠습니까?') ) {
		...
		var params = unit_getParams("searchArea");
		params.status = "DELETE";
		params.query = "deleteMngFaceData";
		params.mngLoginIdx = localStorage.getItem("mngLoginIdx");
