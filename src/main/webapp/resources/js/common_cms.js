...
function inputDateComparison(obj) {
    ...
    var startDate = inputDateSplit( $('.datepicker').eq(0).val() );    // 시작일
    var endDate = inputDateSplit( $('.datepicker').eq(1).val() );        // 종료일
