	...
	<table class="view_tbl01" summary="">
		...
		<tbody>
			<tr>
				...
				<td>
					<div class="form-inline">
						<input type="text" name="ntcTitle" class="form-control form-control-sm col-8" title="제목 입력" />
			...
			<tr>
				...
				<td>
					<div class="form-inline">
						<input type="text" class="form-control form-control-sm datepicker col-2" title="등록일" disabled  />
					</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<th scope="row">내용</th>
				<td>
					<textarea class="designTextarea form-control form-control-sm" name="ir1" id="ir1" style="display:none;width:100%; height:300px !important;" title="내용 입력"></textarea>
				</td>
			</tr>		
		</tbody>
	</table>
...
// 		var params = params = unit_getParams("section");
	...
	//	2. 유효성 검사 서비스로 이동
		var result = ${unit.ajax("notice_write", "params")};
