	...
	<div class="sectionWrap">
		<div class="sub_common_left">
			<div class="sub_box sub_common_title sub_common_title_m">
				<h3>노인복지 프로그램 함께할 팀원 구함</h3>
				<h4>서울 노인복지프로그램 개발 프로젝트</h4>
			...
			<div id="social_content" class="sub_box social_content">
				...
				<h3>팀 소개</h3>
				<p class="sub_box_txt">안녕하세요. 노인과 바다는 서울 지역의 노인 문제에 집중했습니다. 노인과 바다는 다양한 사회복지 프로그램을 설계하고 직접 노인들에게 사회복지 프로그램을 제공합니다.</p>
				<h3>모임 시간</h3>
				<p class="sub_box_txt">매주 목요일 7~8시</p>
				<h3>모임 장소</h3>
				<p class="sub_box_txt">서울시 역삼동 인근 카페</p>
				<h3>모집분야/인원</h3>
				<p class="sub_box_txt">사회복지 전공생 / 1명</p>
				<h3>모집 자격</h3>
			...
			<div id="sub_common_qna" class="sub_box sub_common_qna">
				<h3><strong>Q&amp;A</strong> 노인과 바다 팀에게 질문하기</h3>
		...
		<div class="sub_common_right">
			...
			<p class="sub_share"><a href="#none" title="공유하기"><i class="far fa-share-alt"></i>공유하기</a></p>
			<div class="sub_box sub_common_teams">
				<h3><strong>현재 팀원</strong> (8명)</h3>
			...
			<p class="sub_box_button">
				<button class="btn_blk btn_team_common" onclick="fn_toSocial();">사회문제 메인 바로가기</button>
			</p>
		</div>
	</div>
</div>
