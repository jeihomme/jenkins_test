...
<body>
	<div id="wrap">
		<header id="header">
			<div class="topMenu">
				...
				<p>
					...
					<button class="btn_srch"><img src="/resources/images/icon_srch.png" alt="검색"/></button>
				</p>
				<div>
					<ul>
			...
			<nav id="gnb">
				<ul>
					...
					<li><a href="#none" title="SNS">SNS</a></li>
					<li><a href="#none" title="가치샵">가치샵</a></li>
		...
		<div class="m_footer">
			<ul>
				<li><a href="/front/contest/index" title="공모전"><i class="fal fa-hand-receiving"></i></a></li>
				<li><a href="/front/social/index" title="사회문제"><i class="fal fa-hands-heart"></i></a></li>
				<li><a href="#none" title="SNS"><i class="fal fa-share-alt"></i></a></li>
				<li><a href="#none" title="가치샵"><i class="fal fa-box-alt"></i></a></li>
	...
	<div id="menuMobile">
		<div class="menuMobileWrap">
			<ul class="menuMobile_listM">
				...
				<li><a href="/front/social/index" title="사회문제 도전"><img src="/resources/images/icon_mobile_02.png" alt="사회문제 도전"/>사회문제 도전</a></li>
				<li>
					...
					<ul class="menuMobile_listS">
						...
						<li><a href="/front/mypage/myteam_list" title="팀 관리"><img src="/resources/images/icon_mobile_03_2.png" alt="팀 관리"/>팀 관리</a></li>
				...
				<li><a href="/front/info/contest_reg" title="공모전 등록/홍보"><i><img src="/resources/images/icon_mobile_04.png" alt="공모전 등록/홍보"/></i>공모전 등록/홍보</a></li>
			</ul>
		</div>
	</div>
	<div id="modal_expire">
	...
	<div id="modal_teamApply" class="modal_team_view">
		...
		<div class="modal_team_viewWrap">
			<h3>팀원 지원하기</h3>
			<div class="modal_team_viewContents">
				<p><input type="text" name="teamApplyTitle" title="역량 입력" placeholder="자신의 역량을 적어주세요."/></p>
				<p><textarea placeholder="팀에 임하는 마음가짐을 적어주세요."></textarea></p>
			</div>
			<p class="modal_submit_button">
				<a class="fn_modalSubmitCancel" href="#none" title="취소">취소</a>
				<a class="fn_modalLeaveQnaSubmit" href="#none" title="확인">확인</a>
			</p>
		</div>
	</div>
		...
		<div class="modal_team_viewWrap">
			...
			<div class="modal_team_viewContents">
				<p class="teamAdd_search">
					<input type="text" name="teamAddTitle" title="아이디, 닉네임 검색" placeholder="아이디, 닉네임을 검색해주세요."/>
					<button class="btn_srch"><img src="/resources/images/icon_srch.png" alt="검색"/></button>
				</p>
				<p class="teamAdd_title">검색결과</p>
				<ul class="teamAdd_list">
					<li>
						<a href="#none" title="사용자 프로필">
							<p class="alarm_pic"><img src="/resources/images/profile_picture.png" alt="프로필 사진"/></p>
							<p class="alarm_txt">
								<strong>김스타</strong>
								<span>Kimstar@naver.com</span>
							</p>
						</a>
					</li>
					<li>
			...
			<p class="modal_submit_button">
				<a class="fn_modalSubmitCancel" href="#none" title="취소">취소</a>
				<a class="fn_modalLeaveQnaSubmit" href="#none" title="선택">선택</a>
			</p>
		</div>
	</div>
	...
	<div id="modal_profileEditAccess" class="modal_team_view">
		<p class="modal_guide_banner_close"><a href="#none" title="닫기"><img src="/resources/images/info_guide_close.png" alt="닫기"/></a></p>
		<div class="modal_team_viewWrap">
			<h3>정보 수정을 위한 인증</h3>
			<div class="modal_team_viewContents">
				<p><input id="profileEditAccessPW" type="password" title="비밀번호 입력" placeholder="비밀번호를 입력하세요."/></p>
				<p><input id="profileEditAccessPWR" type="password" title="비밀번호 재입력" placeholder="비밀번호를 다시 입력하세요."/></p>
			</div>
			<p class="modal_submit_button">
				<a class="fn_modalSubmitCancel" href="#none" title="취소">취소</a>
				<a onclick="fn_toModify();" href="#none" title="확인">확인</a>
			</p>
		</div>
	</div>
	...
	<div id="modal_estimate" class="modal_team_view">
		...
		<div class="modal_team_viewWrap">
			...
			<div class="modal_team_viewContents">
				...
				<p class="estimate_commercial_date">
					<span>등록기간</span>
					<input id="datepicker_commercialBegin" type="text" name="commercialBeginDate" title="광고 시작일"/> <strong>-</strong> <input id="datepicker_commercialEnd" type="text" name="commercialEndDate" title="광고 종료일"/>
				</p>
